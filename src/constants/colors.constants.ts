export const COLORS = {
  ...
  /**
   * Leaderboard header banner: 90deg gradient stops per tier (Beginners keep PRIMARY_BLUE_* in UI).
   * Tuned to dark theme + existing teal / amber / slate accents.
   */
  LEADERBOARD_BANNER_EXPLORER_START: '#0F172A',
  LEADERBOARD_BANNER_EXPLORER_END: '#0D9488',
  LEADERBOARD_BANNER_THINKER_START: '#1E1B4B',
  LEADERBOARD_BANNER_THINKER_END: '#4F46E5',
  LEADERBOARD_BANNER_CREATOR_START: '#3B0764',
  LEADERBOARD_BANNER_CREATOR_END: '#7C3AED',
  LEADERBOARD_BANNER_LEADER_START: '#431407',
  LEADERBOARD_BANNER_LEADER_END: '#D97706',
  LEADERBOARD_BANNER_GATEKEEPER_START: '#18181B',
  LEADERBOARD_BANNER_GATEKEEPER_END: '#B45309',

  // Modal overlay
  MODAL_BACKDROP: 'rgba(0, 0, 0, 0.9)',
